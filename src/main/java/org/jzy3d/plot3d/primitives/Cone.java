...
public class Cone extends Composite {	
    ...
    public void setData(Coord3d position, float height, float radius, int slices, 
        ...
        for(int i=0; i<slices; i++){
            ...
            // compute bottom face
            bottom.add(new Point(new Coord3d(position.x+border1.x, position.y+border1.y, position.z)));
        }
